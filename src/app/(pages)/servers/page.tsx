    ...
    <div className="mt-10 flex w-full flex-col items-center justify-center gap-10">
      <header className="w-full max-w-[980px]">
        ...
        <p className="text-muted-foreground mt-2 text-sm">
          Live statistics of the internet server tracker: the public Java servers MC Utils continuously scans,
          and the platforms, versions, and locations it has discovered.
        </p>
      </header>
